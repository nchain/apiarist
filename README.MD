...
If you want your hives to *hummmm*, they need to be well planned. *beehive* is designed with the following intentions:
...
bee_num: 61               # number of bee nodes you wanna run within a sigle host machine
